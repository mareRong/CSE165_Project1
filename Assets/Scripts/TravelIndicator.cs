...
public class TravelIndicator : MonoBehaviour
{
    ...
    [SerializeField] private Transform indicatorOrigin;
    ...
    [SerializeField, Min(0.2f)] private float turnArcRadius = 0.75f;
    [SerializeField, Range(15f, 180f)] private float turnArcDegrees = 65f;
    [SerializeField, Range(3, 24)] private int turnArcSegments = 10;
    [SerializeField] private float verticalOffset = -0.03f;
    [SerializeField] private Color moveColor = new Color(0.17f, 0.9f, 0.78f, 1f);
    [SerializeField] private Color turnColor = new Color(1f, 0.73f, 0.21f, 1f);
